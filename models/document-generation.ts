...
export enum ResearchTechnique {
  ...
  REVIEW_JWCC_CONTRACTS_AND_OR_CONTRACTORS_CATALOG = "REVIEW_JWCC_CONTRACTS_AND_OR_CONTRACTORS_CATALOG",
  OTHER = "OTHER",
}
  ...
  properties: {
    technique_value: {
      enum: [
        ...
        ResearchTechnique.REVIEW_JWCC_CONTRACTS_AND_OR_CONTRACTORS_CATALOG,
...
export const generateDocumentEventSchema = {
  type: "object",
  properties: {
